    ...
    return (
        <div className="flex items-center justify-between p-5">
            ...
            <div className="flex flex-col items-start">
                ...
                <h2 className="lg:text-base text-xs text-left leading-tight text-dark dark:text-white">Welcome to CybrNinja</h2>
            </div>
            {/* user details */}
            <div className="flex items-center lg:gap-2 gap-1">
                <div className="flex flex-col">
                    <span className="lg:text-base text-xs text-right leading-2 font-medium">John Doe</span>
