...
def pre_generate_questions(openai_client, difficulty="medium", target_questions=5, batch_size=1):
    questions_collected = []
    ...
    while len(questions_collected) < target_questions:
        ...
        '{difficulty}' means subtle clues and multi-step reasoning (e.g., slightly off URLs, urgent but vague requests).
        ...
        [
            {{"text": "Payment page URL is slightly different. What next?", "options": [{{"text": "Proceed", "is_correct": false, "feedback": "URL changes can signal phishing."}}, {{"text": "Contact support", "is_correct": true, "feedback": "Verify via official channels."}}, {{"text": "Check again", "is_correct": false, "feedback": "Still risky without verification."}}], "difficulty": "{difficulty}", "hint": "Look at the URL closely."}},
            ...
        ]
        Each object needs:
        - "text": short question,
