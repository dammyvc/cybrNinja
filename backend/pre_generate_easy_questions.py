...
def pre_generate_questions(openai_client, difficulty="easy", target_questions=5, batch_size=1):
    questions_collected = []
    ...
    while len(questions_collected) < target_questions:
        ...
        '{difficulty}' means obvious clues and straightforward scenarios (e.g., unsolicited emails with clear red flags).
        ...
        [
            {{"text": "Email asks for bank login. What do you do?", "options": [{{"text": "Click link", "is_correct": false, "feedback": "Never click unsolicited links."}}, {{"text": "Call bank", "is_correct": true, "feedback": "Verify via official channels."}}, {{"text": "Reply", "is_correct": false, "feedback": "Don’t engage."}}], "difficulty": "{difficulty}", "hint": "Check the source."}},
            ...
        ]
        Each object needs:
        - "text": short question,
